...
function Info() {
  ...
  return (
    <div className="w-full mx-auto bg-[#011627] text-white p-6 rounded-xl shadow-lg">
      <h3 className="text-xl font-semibold mb-4 border-b pb-2">Kişisel Bilgiler</h3>
      ...
      <div className="mt-6 flex gap-4">
        <a href={about[0].instagram} className="text-pink-500 hover:text-pink-600"><FaInstagram size={18} /></a>
        <a href={about[0].instagram} className="text-red-500 hover:text-red-600"><FaYoutube size={18} /></a>
        <a href={about[0].linkedin} className="text-blue-500 hover:text-blue-600"><FaLinkedin size={18} /></a>
        <a href={about[0].github} className="text-gray-400 hover:text-gray-500"><FaGithub size={18} /></a>
      </div>
    </div>
  );
}
